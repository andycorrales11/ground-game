...
def test_simulate_cpu_pick():
    ...
    full_player_df = create_test_player_df()
    team = Team()
    ...
    picks = [simulate_cpu_pick(available_players, team, full_player_df) for _ in range(10)]
    ...
    picks_with_need = [simulate_cpu_pick(available_players, team, full_player_df) for _ in range(20)]
